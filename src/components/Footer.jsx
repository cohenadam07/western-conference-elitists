  ...
  return (
    <footer className="border-t border-line bg-surface">
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
            ...
            <div className="mt-6 flex gap-3">
              {SOCIALS.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-line text-xs text-bone-dim transition-colors hover:border-ember hover:text-ember"
                >
                  {s.label.slice(0, 1)}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li><Link className="text-bone-dim hover:text-bone" to="/about">About</Link></li>
              <li><Link className="text-bone-dim hover:text-bone" to="/contact">Contact</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-line pt-8 text-xs text-mute sm:flex-row">
